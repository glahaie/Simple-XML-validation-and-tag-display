...
/* TypeBalise :
   definit les cinq types de balises gerees : balises de debut (<TEXT>), de fin (</TEXT>), balises de début qui se terminent sans contenu (<TEXT/>),
...
/* baliseCree :
   ...
   Pour les balises COMMENTAIRES et DIRECTIVE, ni le nom ni les attributs ne sont spécifiés (pointeur NULL).
   Pour les autres balises, le nom doit être une chaine valide (pointeur non NULL)
*/
...
/* baliseLitNom :
   ...
   balise doit être une balise valide (pointeur non NULL) de type DEBUT, FIN ou DEBUTFIN.
*/
...
/* baliseLitType :
   ...
   balise doit être une balise valide (pointeur non NULL)
*/
